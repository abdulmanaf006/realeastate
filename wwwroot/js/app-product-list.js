$(function() {
    let e, s, n;
    // n = (isDarkStyle ? (e = config.colors_dark.borderColor,
    ...
    $.getJSON("api/products.php", function(resp) {
        var invoiceData = resp && resp.ok ? resp.data : [];
        var t, a = $(".datatables-products"),
        o = {
            1: {
                title: "Scheduled",
                ...
                buttons: [{
                    ...
                    buttons: [{
                        ...
                        customize: function(t) {
                            $(t.document.body).css("color", n).css("border-color", e).css("background-color", s),
                    ...
                    action: function() {
                        window.location.href = "app-product-add.php"
                    }
                }],
                responsive: {
                    details: {
