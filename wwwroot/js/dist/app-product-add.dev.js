...
!function () {
  ...
  e.length && (s = 2, o = 1, e.on("submit", function (e) {
    e.preventDefault();
  }), e.repeater({
    show: function show() {
      ...
      }), s++, $(this).slideDown(), $(".select2-container").remove(), $(".select2.form-select").select2({
        placeholder: "Placeholder text"
      }), $(".select2-container").css("width", "100%"), $(".form-repeater:first .form-select").select2({
...
//# sourceMappingURL=app-product-add.dev.js.map
