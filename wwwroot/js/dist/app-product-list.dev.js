...
$(function () {
  var e, s, n; // n = (isDarkStyle ? (e = config.colors_dark.borderColor,
  ...
  a.length && (t = a.DataTable({
    ...
    columnDefs: [{
      ...
      targets: 0,
      render: function render(t, e, s, n) {
        return "";
      }
    }, {
      targets: 1,
      ...
      render: function render(t, e, s, n) {
        ...
        return "<span class='text-truncate d-flex align-items-center text-heading'>" + {
          Household: '<span class="w-px-30 h-px-30 rounded-circle d-flex justify-content-center align-items-center bg-label-warning me-4 p-3"><i class="bx bx-briefcase bx-sm"></i></span>',
          Office: '<span class="w-px-30 h-px-30 rounded-circle d-flex justify-content-center align-items-center bg-label-info me-4 p-3"><i class="bx bx-home-smile bx-sm"></i></span>',
          Electronics: '<span class="w-px-30 h-px-30 rounded-circle d-flex justify-content-center align-items-center bg-label-danger me-4 p-3"><i class="bx bx-headphone bx-sm"></i></span>',
          Shoes: '<span class="w-px-30 h-px-30 rounded-circle d-flex justify-content-center align-items-center bg-label-success me-4"><i class="bx bx-walk bx-sm"></i></span>',
          Accessories: '<span class="w-px-30 h-px-30 rounded-circle d-flex justify-content-center align-items-center bg-label-secondary me-4"><i class="bx bxs-watch bx-sm"></i></span>',
      ...
      render: function render(t, e, s, n) {
        ...
        }[c[s].title] + '<span class="d-none">' + c[s].title + "</span></span>";
      }
    }, {
      targets: 5,
      render: function render(t, e, s, n) {
      ...
      orderable: !1,
      render: function render(t, e, s, n) {
        return '<div class="d-inline-block text-nowrap"><button class="btn btn-icon"><i class="bx bx-edit bx-md"></i></button><button class="btn btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="bx bx-dots-vertical-rounded bx-md"></i></button><div class="dropdown-menu dropdown-menu-end m-0"><a href="javascript:0;" class="dropdown-item">View</a><a href="javascript:0;" class="dropdown-item">Suspend</a></div></div>';
      }
    }],
    order: [2, "asc"],
    ...
    buttons: [{
      ...
      buttons: [{
        ...
        exportOptions: {
          ...
          format: {
            body: function body(t, e, s) {
              var n;
              return t.length <= 0 ? t : (t = $.parseHTML(t), n = "", $.each(t, function (t, e) {
                void 0 !== e.classList && e.classList.contains("product-name") ? n += e.lastChild.firstChild.textContent : void 0 === e.innerText ? n += e.textContent : n += e.innerText;
              }), n);
            }
          }
        },
        customize: function customize(t) {
          $(t.document.body).css("color", n).css("border-color", e).css("background-color", s), $(t.document.body).find("table").addClass("compact").css("color", "inherit").css("border-color", "inherit").css("background-color", "inherit");
        }
      }, {
        extend: "csv",
      ...
      action: function action() {
        window.location.href = "app-product-add.html";
      }
    }],
    responsive: {
      details: {
        ...
        type: "column",
        renderer: function renderer(t, e, s) {
    ...
    initComplete: function initComplete() {
      this.api().columns(-2).every(function () {
        ...
        e.data().unique().sort().each(function (t, e) {
          s.append('<option value="' + i[t].title + '">' + i[t].title + "</option>");
        });
        ...
        e.data().unique().sort().each(function (t, e) {
          s.append('<option value="' + c[t].title + '">' + r[t].title + "</option>");
        });
      });
    }
  }), $(".dataTables_length").addClass("mx-n2"), $(".dt-buttons").addClass("d-flex flex-wrap mb-6 mb-sm-0")), $(".datatables-products tbody").on("click", ".delete-record", function () {
    t.row($(this).parents("tr")).remove().draw();
  }), setTimeout(function () {
    $(".dataTables_filter .form-control").removeClass("form-control-sm"), $(".dataTables_length .form-select").removeClass("form-select-sm");
  }, 300);
});
//# sourceMappingURL=app-product-list.dev.js.map
