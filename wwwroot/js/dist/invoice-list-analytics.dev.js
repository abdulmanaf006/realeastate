...
$(function () {
  var a,
      e = $(".invoice-list-table"); // JSON data (replace with your actual data)
  ...
  e.length && (a = e.DataTable({
    ...
    columnDefs: [{
      ...
      searchable: !1,
      targets: 0,
      render: function render(a, e, t, s) {
        return "";
      }
    }, {
      targets: 1,
    ...
    buttons: [{
      ...
      action: function action(a, e, t, s) {
    ...
    responsive: {
      details: {
        ...
        type: "column",
        renderer: function renderer(a, e, t) {
...
//# sourceMappingURL=invoice-list-analytics.dev.js.map
