...
var options = {
  ...
  yaxis: {
    labels: {
      ...
      style: {
        fontSize: "13px",
        fontFamily: "Public Sans" // colors: r
...
var chart = new ApexCharts(document.querySelector("#conversionRateChart"), options);
chart.render();
/*6 chart*/
...
var chart = new ApexCharts(document.querySelector("#expensesBarChart"), options);
chart.render();
/*7 chart*/
...
chart.render();
//# sourceMappingURL=dashboards-analytics.dev.js.map
